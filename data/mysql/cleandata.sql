...
VALUES (0,4,1,NULL,NULL,'Ibexa Digital Experience Platform','ezstring',1,'eng-GB',3,0,'ibexa digital experience platform',9),
       ...
       (0,155,1,NULL,NULL,'Ibexa Digital Experience Platform','ezstring',102,'eng-GB',3,0,'ibexa digital experience platform',9),
       (0,155,41,0,0,'','ezstring',103,'eng-GB',3,0,'',1),
       (0,156,1,NULL,NULL,'<?xml version="1.0" encoding="UTF-8"?><section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"><para>This is the clean installation coming with Ibexa Digital Experience Platform.</para><para>It''s a bare-bones setup of the Platform, an excellent foundation to build upon if you want to start your project from scratch.</para></section>','ezrichtext',104,'eng-GB',3,0,'',9),
...
VALUES ('eng-GB',9,1,2,'Ibexa Digital Experience Platform','eng-GB'),
