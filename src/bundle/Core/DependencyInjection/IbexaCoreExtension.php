...
use Ibexa\Bundle\Core\DependencyInjection\Configuration\ContainerConfigurator;
...
class IbexaCoreExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function prepend(ContainerBuilder $container)
    {
        ...
        (new ContainerConfigurator\Generic())->configure($container);
        (new ContainerConfigurator\PlatformSh())->configure($container);
    }
