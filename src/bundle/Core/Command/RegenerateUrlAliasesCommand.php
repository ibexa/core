...
EOT;
    ...
    protected static $defaultDescription = 'Regenerates Location URL aliases (autogenerated) and cleans up custom ' .
                                           'Location and global URL aliases stored in the Legacy Storage Engine';
