...
class ContentContext implements Context
{
    ...
    public function iCreateAnFolderDraft(): void
    {
        $this->currentDraft = $this->createDraft(
            ...
            [
                ...
                'short_description' => '<?xml version="1.0" encoding="UTF-8"?><section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"><para>This is a paragraph.</para></section>',
            ]
        );
    }
    ...
    public function updateDraft($fields)
    {
        ...
        $updatedDraft = $this->repository->sudo(function () use ($updateStruct): Content {
    ...
    public function createDraft($contentTypeIdentifier, array $fields)
    {
        ...
        $this->currentDraft = $this->repository->sudo(
            function () use ($createStruct, $locationCreateStruct): Content {
