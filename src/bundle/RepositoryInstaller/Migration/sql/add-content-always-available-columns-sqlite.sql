ALTER TABLE ibexa_content ADD COLUMN always_available BOOLEAN DEFAULT '0' NOT NULL;
-- ibexa:sql-statement-separator
ALTER TABLE ibexa_content_version ADD COLUMN always_available BOOLEAN DEFAULT '0' NOT NULL;
-- ibexa:sql-statement-separator
