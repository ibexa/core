...
/**
 * @implements \Ibexa\Contracts\Core\Repository\Values\ContentType\Query\CriterionHandlerInterface<\Ibexa\Contracts\Core\Repository\Values\ContentType\Query\Criterion\LogicalOr>
 */
final class LogicalOr extends Base
{
    ...
    {
        $constraints = [];
        /** @var \Ibexa\Contracts\Core\Repository\Values\ContentType\Query\Criterion\LogicalOr $criterion */
        ...
        $qb->andWhere($qb->expr()->or(...$constraints));
    }
}
