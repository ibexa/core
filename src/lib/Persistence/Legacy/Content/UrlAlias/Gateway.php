...
abstract class Gateway
{
     ...
     *
     * @param array $values associative array with column names as keys and column values as
     *        values - "language_ids" (int[]) is a pseudo-column: it replaces the row's
     *        translations in "ibexa_url_alias_ml_translation" instead of mapping to a real column.
     */
     ...
     *
     * @param array $values see {@see updateRow()} for the "language_ids" pseudo-column
     */
     ...
     *
     * If the found entry carries more than one language, $languageId is removed from its set of
     * translations. Otherwise entry will be marked as history.
     */
    ...
    /**
     * Removes $languageId's translation rows for multiple Locations.
     *
