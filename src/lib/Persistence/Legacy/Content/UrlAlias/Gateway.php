...
abstract class Gateway
{
     ...
     *
     * @throws NotFoundException if the given language doesn't exist
     */
     ...
     */
    abstract public function updateRow(
        int $parentId,
        string $textMD5,
        array $values
    ): void;
     ...
     */
    abstract public function historizeBeforeSwap(
        string $action,
        int $languageMask
    ): void;
     ...
     */
    abstract public function historizeId(
        int $id,
        int $link
    ): void;
     ...
     */
    abstract public function reparent(
        int $oldParentId,
        int $newParentId
    ): void;
     ...
     */
    abstract public function removeCustomAlias(
        int $parentId,
        string $textMD5
    ): bool;
     ...
     */
    abstract public function bulkRemoveTranslation(
        int $languageId,
        array $actions
    ): void;
