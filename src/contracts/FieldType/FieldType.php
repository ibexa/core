 ...
 * Hashes:
 *
 * The {@see toHash()} method in this class is meant to generate a simple
 ...
 * The corresponding {@see fromHash()} method must convert such a
...
abstract class FieldType
{
     ...
     * returned by {@see getValidatorConfigurationSchema()}.
     *
     ...
     * correct and comply to the settings schema returned by {@see getSettingsSchema()}.
     *
     ...
     * been processed by {@see acceptValue()}.
     *
     * @param \Ibexa\Contracts\Core\FieldType\Value $value
     *
     * @return bool
     ...
     * type as e.g. returned by {@see getEmptyValue()}.
     *
     ...
     *
     * This is the reverse operation to {@see toHash()}. At least the hash
     * format generated by {@see toHash()} must be converted in reverse.
