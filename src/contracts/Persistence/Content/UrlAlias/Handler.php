...
interface Handler
{
     ...
     * List global aliases.
     *
     * @throws BadStateException if path for any of the global URL aliases is broken
     *
     * @param string|null $languageCode
     * @param int $offset
     * @param int $limit
     ...
     *
     * @throws BadStateException if any path for the Location is broken
     *
     * @param mixed $locationId
     ...
     * @throws BadStateException if the stored path for the given URL is broken
     *
     * @param string $url
     *
     * @return UrlAlias
     ...
     *
     * @throws BadStateException if path for the given URL alias is broken
     *
