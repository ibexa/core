 ...
 *
 * @phpstan-property-read mixed $id internal id of the policy
 * @phpstan-property-read mixed $roleId the role id this policy belongs to
 * @phpstan-property-read string $module Name of module, associated with the Policy
 * @phpstan-property-read string $function  Name of the module function Or all functions with '*'
