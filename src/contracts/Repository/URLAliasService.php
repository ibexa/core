...
interface URLAliasService
{
     ...
     *
     * @throws UnauthorizedException if the user is not allowed to create url alias
     * @throws InvalidArgumentException if the path already exists for the given context
     *
     * @return URLAlias
     */
     ...
     * $alwaysAvailable makes the alias available in all languages.
     *
     * @throws UnauthorizedException if the user is not allowed to create global
     *          url alias
     * @throws InvalidArgumentException if the path already exists for the given
     ...
     *
     * @throws UnauthorizedException if the user is not allowed to remove url alias
     * @throws InvalidArgumentException if alias list contains
     *         autogenerated alias
     *
     ...
     * @throws InvalidArgumentException if the path exceeded maximum depth level
     *
     * @return URLAlias
     */
     ...
     *
     * @throws NotFoundException if no url alias exist for the given language
     *
     * @param Location $location
     * @param string|null $languageCode filters those which are valid for the given language
     * @param bool|null $showAllTranslations If enabled will include all alias as if they where always available.
