...
class UrlAliasTest extends BaseServiceMockTest
{
    ...
    public static function providerForTestListAutogeneratedLocationAliasesPath()
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesPath')]
    ...
    public static function providerForTestListAutogeneratedLocationAliasesEmpty()
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesEmpty')]
    ...
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodePath()
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodePath')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodeEmpty')]
    ...
    public static function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesPath()
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesMultipleLanguagesPath')]
    ...
    public static function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesEmpty()
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesMultipleLanguagesEmpty')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesPath')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesEmpty')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesAlwaysAvailablePath')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailablePath')]
     ...
     * Test for the listLocationAliases() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailableEmpty')]
    ...
    public static function providerForTestLookupThrowsNotFoundExceptionPath()
    {
        return [
     ...
     * Test for the lookup() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestLookupThrowsNotFoundExceptionPath')]
    ...
    public static function providerForTestLookup()
    {
        return [
     ...
     * Test for the lookup() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestLookup')]
     ...
     * Test for the lookup() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestLookupWithSharedTranslation')]
    ...
    public static function providerForTestReverseLookup()
    {
     ...
     * Test for the reverseLookup() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestReverseLookup')]
     ...
     * Test for the reverseLookup() method.
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForTestReverseLookupAlwaysAvailablePath')]
     ...
     * Test for the createGlobalUrlAlias() method.
     */
    #[\PHPUnit\Framework\Attributes\DependsExternal(self::class, 'testCreateUrlAlias')]
    #[\PHPUnit\Framework\Attributes\DependsExternal(self::class, 'testCreateUrlAliasWithRollback')]
    #[\PHPUnit\Framework\Attributes\DependsExternal(self::class, 'testCreateUrlAliasThrowsInvalidArgumentException')]
