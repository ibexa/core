...
class UrlAliasTest extends BaseServiceMockTest
{
     ...
     * Test for the load() method.
     */
    public function testLoadThrowsNotFoundExceptionPath(): void
    {
     ...
     */
    public function testRemoveAliasesThrowsInvalidArgumentException(): void
    {
     ...
     * Test for the removeAliases() method.
     */
    public function testRemoveAliasesWithRollback(): void
    {
        $aliasList = [
            new URLAlias([
                'id' => self::EXAMPLE_ID,
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesPath(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
    ...
    public function testListAutogeneratedLocationAliasesPath($spiUrlAliases, $prioritizedLanguageCodes, $paths): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
     ...
     * Test for the load() method.
     */
    public function testListLocationAliasesWithShowAllTranslations(): void
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * Test for the load() method.
     */
    public function testListLocationAliasesWithShowAllTranslationsCustomConfiguration(): void
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesEmpty(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
    ...
    public function testListAutogeneratedLocationAliasesEmpty($spiUrlAliases, $prioritizedLanguageCodes): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodePath(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeEmpty(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesPath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function testListAutogeneratedLocationAliasesMultipleLanguagesPath($spiUrlAliases, $prioritizedLanguageCodes, $paths): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function testListAutogeneratedLocationAliasesMultipleLanguagesEmpty($spiUrlAliases, $prioritizedLanguageCodes): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesPath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesAlwaysAvailablePath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailablePath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * @return array<mixed>
     */
    public static function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailableEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     * Test for the listGlobalAliases() method.
     */
    public function testListGlobalAliasesEmpty(): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService();
     ...
     * Test for the listGlobalAliases() method.
     */
    public function testListGlobalAliasesWithParameters(): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService();
     ...
     * @return array<mixed>
     */
    public static function providerForTestLookupThrowsNotFoundExceptionPath(): array
    {
        return [
     ...
     * @return array<mixed>
     */
    public static function providerForTestLookup(): array
    {
        return [
    ...
    public function testLookup($prioritizedLanguageList, $showAllTranslations, $alwaysAvailable, $languageCode): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageList,
     ...
     * @return array<mixed>
     */
    public static function providerForTestLookupWithSharedTranslation(): array
    {
        return [
            // showAllTranslations setting is true
            [['ger-DE'], true, false, null],
     ...
     */
    public function testReverseLookupCustomConfiguration(): void
    {
        $this->expectException(NotFoundException::class);
     ...
     * Test for the reverseLookup() method.
     */
    public function testReverseLookupThrowsNotFoundException(): void
    {
        $this->expectException(NotFoundException::class);
     ...
     * @return array<mixed>
     */
    public static function providerForTestReverseLookup(): array
    {
    ...
    public function testReverseLookupPath($spiUrlAliases, $prioritizedLanguageCodes, $paths, $reverseLookupLanguageCode): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
     ...
     * @return array<mixed>
     */
    public static function providerForTestReverseLookupAlwaysAvailablePath(): array
    {
     ...
     * Test for the reverseLookup() method.
     */
    public function testReverseLookupWithShowAllTranslations(): void
    {
        $spiUrlAlias = $this->getSpiUrlAlias();
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
     ...
     * Test for the createUrlAlias() method.
     */
    public function testCreateUrlAliasWithRollback(): void
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('Handler threw an exception');
     ...
     */
    public function testCreateGlobalUrlAlias(): void
    {
     ...
     * Test for the createGlobalUrlAlias() method.
     */
    public function testCreateGlobalUrlAliasWithRollback(): void
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('Handler threw an exception');
     ...
     * Test for the createGlobalUrlAlias() method.
     */
    public function testCreateGlobalUrlAliasThrowsInvalidArgumentExceptionResource(): void
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * Test for the createGlobalUrlAlias() method.
     */
    public function testCreateGlobalUrlAliasThrowsInvalidArgumentExceptionPath(): void
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * Test for the createGlobalUrlAlias() method.
     */
    #[DependsExternal(self::class, 'testCreateUrlAlias')]
    #[DependsExternal(self::class, 'testCreateUrlAliasWithRollback')]
    #[DependsExternal(self::class, 'testCreateUrlAliasThrowsInvalidArgumentException')]
    public function testCreateGlobalUrlAliasForLocation(): void
    {
        $repositoryMock = $this->getRepositoryMock();
