...
class UrlAliasTest extends BaseServiceMockTest
{
    ...
    protected function getSpiUrlAlias(): SPIUrlAlias
    {
        $pathElement1 = [
    ...
    public function providerForTestListAutogeneratedLocationAliasesPath(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     */
    public function testListAutogeneratedLocationAliasesPath(array $spiUrlAliases, array $prioritizedLanguageCodes, array $paths): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
    ...
    public function providerForTestListAutogeneratedLocationAliasesEmpty(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
     ...
     */
    public function testListAutogeneratedLocationAliasesEmpty(array $spiUrlAliases, array $prioritizedLanguageCodes): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodePath(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeEmpty(): array
    {
        $pathElement1 = [
            'always-available' => true,
            'translations' => [
    ...
    public function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesPath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     */
    public function testListAutogeneratedLocationAliasesMultipleLanguagesPath(array $spiUrlAliases, array $prioritizedLanguageCodes, array $paths): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
    ...
    public function providerForTestListAutogeneratedLocationAliasesMultipleLanguagesEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
     ...
     */
    public function testListAutogeneratedLocationAliasesMultipleLanguagesEmpty(array $spiUrlAliases, array $prioritizedLanguageCodes): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesPath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeMultipleLanguagesEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function providerForTestListAutogeneratedLocationAliasesAlwaysAvailablePath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailablePath(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function providerForTestListAutogeneratedLocationAliasesWithLanguageCodeAlwaysAvailableEmpty(): array
    {
        $spiUrlAliases = [
            new SPIUrlAlias(
                [
    ...
    public function providerForTestLookupThrowsNotFoundExceptionPath(): array
    {
        return [
     ...
     */
    public function testLookupThrowsNotFoundExceptionPathNotMatchedOrNotLoadable(string $url, array $prioritizedLanguageList, string $languageCode): void
    {
        $this->expectException(NotFoundException::class);
    ...
    public function providerForTestLookup(): array
    {
        return [
     ...
     */
    public function testLookup(array $prioritizedLanguageList, bool $showAllTranslations, bool $alwaysAvailable, ?string $languageCode): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageList,
    ...
    public function providerForTestLookupWithSharedTranslation(): array
    {
        return [
            // showAllTranslations setting is true
            [['ger-DE'], true, false, null],
     ...
     */
    public function testReverseLookupPath(array $spiUrlAliases, array $prioritizedLanguageCodes, array $paths, $reverseLookupLanguageCode): void
    {
        $urlAliasService = $this->getPartlyMockedURLAliasServiceService(
            null,
            $prioritizedLanguageCodes
     ...
     */
    protected function getLocationStub($id = 42): Location
    {
