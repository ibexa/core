...
final class ContentServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->contentService = new ContentService(
            ...
            self::createStub(RelationProcessor::class),
            self::createStub(NameSchemaServiceInterface::class),
            self::createStub(FieldTypeRegistry::class),
            self::createStub(PermissionService::class),
            self::createStub(ContentMapper::class),
            self::createStub(ContentValidator::class),
            self::createStub(ContentFilteringHandler::class),
