...
#[\PHPUnit\Framework\Attributes\CoversClass(\Ibexa\Core\Persistence\Legacy\Content\Location\Handler::class)]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Persistence\Content\Location\Handler::class, 'countLocationsByContent')]
class LocationHandlerTest extends TestCase
{
    ...
    protected function getLocationHandler()
    {
        return new Handler(
            ...
            $this->locationMapper,
            $this->contentHandler,
            $this->createStub(ObjectStateHandler::class),
            $this->treeHandler
        );
    }
