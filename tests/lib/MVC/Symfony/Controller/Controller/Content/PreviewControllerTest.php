...
final class PreviewControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->controllerChecker = self::createStub(CustomLocationControllerChecker::class);
    ...
    private function configurePreviewHelper(
        ...
        $this->previewHelper
            ->expects($matcher)
            ->method('setPreviewActive')->willReturnCallback(static function (...$parameters) use ($matcher) {
