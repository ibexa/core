...
final class UserWrappedTest extends TestCase
{
    ...
    public function testGetSetWrappedUser(): void
    {
        ...
        $newWrappedUser = $this->createStub(UserInterface::class);
    ...
    public function testRegularUser(): void
    {
        ...
        self::assertTrue($user->isEqualTo($this->createStub(SymfonyUserInterface::class)));
    ...
    public function testIsEqualTo()
    {
        ...
        $user = new UserWrapped($originalUser, $this->apiUser);
        $otherUser = $this->createStub(SymfonyUserInterface::class);
        $originalUser
            ->expects(self::once())
            ->method('isEqualTo')
            ->with($otherUser)
    ...
    {
        $originalUser = $this->createStub(UserInterface::class);
        $user = new UserWrapped($originalUser, $this->apiUser);
