...
class CompoundAndTest extends TestCase
{
    ...
    public function testSetMatcherBuilder(Compound $compoundMatcher): void
    {
        ...
        $compoundMatcher->setRequest(self::createStub(SimplifiedRequest::class));
    ...
    public function testSetRequest(): void
    {
        ...
        $request = self::createStub(SimplifiedRequest::class);
        $matcher1
            ->expects(self::once())
            ->method('setRequest')
            ->with($request);
    ...
    public function testReverseMatchSiteAccessNotConfigured(): void
    {
        ...
        $this->matcherBuilder
            ->expects(self::any())
            ->method('buildMatcher')
            ->will(self::returnValue(self::createStub(VersatileMatcher::class)));
    ...
    public function testReverseMatch(): void
    {
        ...
        $reverseMatchedMatcher1 = self::createStub(VersatileMatcher::class);
        $matcher1
            ->expects(self::once())
            ->method('reverseMatch')
            ->with($siteAccessName)
            ->will(self::returnValue($reverseMatchedMatcher1));
        $reverseMatchedMatcher2 = self::createStub(VersatileMatcher::class);
        $matcher2
            ->expects(self::once())
            ->method('reverseMatch')
            ->with($siteAccessName)
