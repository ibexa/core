...
class HandlerContentSortTest extends AbstractTestCase
{
    ...
    public function testSortFieldText()
    {
        ...
        $idMapSet = [
            ...
            'ibexa dxp' => [144],
            'fastcgi' => [77, 218],
            'fusce sagittis sagittis' => [81],
            'fusce sagittis sagittis urna' => [107],
            'get involved' => [127],
            'how to develop with ibexa' => [118, 211],
            'how to manage ibexa' => [108, 202],
            'how to use ibexa' => [151, 193],
            ...
            'lots of websites, one ibexa installation' => [130],
            'rest api interface' => [150, 214],
            'separate content & design in ibexa' => [191],
