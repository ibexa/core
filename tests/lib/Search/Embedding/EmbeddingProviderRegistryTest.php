...
final class EmbeddingProviderRegistryTest extends TestCase
{
    public function testHasEmbeddingProvider(): void
    {
        $registry = new EmbeddingProviderRegistry([
            'existing' => $this->createStub(EmbeddingProviderInterface::class),
        ]);
    ...
    {
        $expectedEmbeddingProvider = $this->createStub(EmbeddingProviderInterface::class);
    ...
    {
        $embeddingProviderA = $this->createStub(EmbeddingProviderInterface::class);
        $embeddingProviderB = $this->createStub(EmbeddingProviderInterface::class);
