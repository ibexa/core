...
#[\PHPUnit\Framework\Attributes\CoversClass(\Ibexa\Bundle\Core\Imagine\IORepositoryResolver::class)]
final class IORepositoryResolverTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->variationPurger = $this->createStub(VariationPurger::class);
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('getFilePathProvider')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('getDataForTestRemove')]
