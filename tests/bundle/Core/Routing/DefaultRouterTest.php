...
#[\PHPUnit\Framework\Attributes\CoversClass(DefaultRouter::class)]
final class DefaultRouterTest extends TestCase
{
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('providerGenerateNoSiteAccess')]
     ...
     */
    public static function providerGenerateNoSiteAccess(): iterable
    {
        return [
            ['/foo/bar'],
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerGenerateWithSiteAccess')]
     ...
     */
    public static function providerGenerateWithSiteAccess(): iterable
    {
        return [
