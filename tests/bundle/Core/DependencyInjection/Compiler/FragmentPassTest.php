...
class FragmentPassTest extends AbstractCompilerPassTestCase
{
    ...
    public function testProcess()
    {
        ...
        $this->setDefinition(\Ibexa\Bundle\Core\Fragment\DecoratedFragmentRenderer::class, $decoratedFragmentRendererDef);
        $this->setDefinition(\Ibexa\Bundle\Core\Fragment\FragmentListenerFactory::class, new Definition());
        ...
        $this->assertEquals(\Ibexa\Bundle\Core\Fragment\FragmentListenerFactory::class, $factoryArray[0]);
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithParent('fragment.renderer.inline', \Ibexa\Bundle\Core\Fragment\DecoratedFragmentRenderer::class);
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithParent('fragment.renderer.esi', \Ibexa\Bundle\Core\Fragment\DecoratedFragmentRenderer::class);
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithParent('fragment.renderer.hinclude', \Ibexa\Bundle\Core\Fragment\DecoratedFragmentRenderer::class);
