...
#[CoversMethod(URLAliasService::class, 'createUrlAlias')]
#[CoversMethod(URLAliasService::class, 'createUrlAlias($location, $path, $languageCode, $forwarding)')]
#[CoversMethod(URLAliasService::class, 'createUrlAlias($location, $path, $languageCode, $forwarding, $alwaysAvailable)')]
#[CoversMethod(URLAliasService::class, 'createGlobalUrlAlias()')]
#[CoversMethod(URLAliasService::class, 'createGlobalUrlAlias($resource, $path, $languageCode, $forward)')]
#[CoversMethod(URLAliasService::class, 'createGlobalUrlAlias($resource, $path, $languageCode, $forwarding, $alwaysAvailable)')]
#[CoversMethod(URLAliasService::class, 'listLocationAliases()')]
#[CoversMethod(URLAliasService::class, 'listLocationAliases($location, $custom, $languageCode)')]
#[CoversMethod(URLAliasService::class, 'listLocationAliases($location, $custom)')]
#[CoversMethod(URLAliasService::class, 'listGlobalAliases()')]
#[CoversMethod(URLAliasService::class, 'listGlobalAliases($languageCode)')]
#[CoversMethod(URLAliasService::class, 'listGlobalAliases($languageCode, $offset)')]
#[CoversMethod(URLAliasService::class, 'listGlobalAliases($languageCode, $offset, $limit)')]
#[CoversMethod(URLAliasService::class, 'removeAliases()')]
#[CoversMethod(URLAliasService::class, 'lookUp()')]
#[CoversMethod(URLAliasService::class, 'lookUp($url, $languageCode)')]
#[CoversMethod(URLAliasService::class, 'lookUp')]
#[CoversMethod(URLAliasService::class, 'listLocationAliases')]
