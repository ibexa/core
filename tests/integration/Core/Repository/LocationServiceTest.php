...
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'newLocationCreateStruct()')]
...
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'loadLocations($contentInfo, $rootLocation)')]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'loadLocationChildren')]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'loadParentLocationsForDraftContent')]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'getLocationChildCount()')]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'loadLocationChildren()')]
#[\PHPUnit\Framework\Attributes\CoversMethod(\Ibexa\Contracts\Core\Repository\LocationService::class, 'newLocationUpdateStruct')]
...
class LocationServiceTest extends BaseTestCase
{
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testNewLocationCreateStruct')]
     ...
     * Test for the createLocation() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testCreateLocation')]
    #[\PHPUnit\Framework\Attributes\DependsExternal(\Ibexa\Tests\Integration\Core\Repository\ContentServiceTest::class, 'testHideContent')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testNewLocationCreateStruct')]
    #[\PHPUnit\Framework\Attributes\DataProvider('dataProviderForOutOfRangeLocationPriority')]
    ...
    public static function dataProviderForOutOfRangeLocationPriority()
    {
     ...
     * Test for the loadLocation() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocation')]
     ...
     * Test for the loadLocationList() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationList')]
     ...
     * Test for the loadLocationList() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationListPrioritizedLanguagesFallback')]
     ...
     * Test for the loadLocations() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocations')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationsLimitedSubtree')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadParentLocationsForDraftContent')]
     ...
     * Test for the loadLocationChildren() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationChildren')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationChildrenWithOffset')]
    ...
    #[\PHPUnit\Framework\Attributes\Depends('testLoadLocationChildrenWithOffsetAndLimit')]
     ...
     * @throws \Ibexa\Contracts\Core\Repository\Exceptions\Exception
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('providerForLoadLocationChildrenRespectsParentSortingClauses')]
     ...
     * Test for the updateLocation() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testUpdateLocation')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testSwapLocationForMainAndSecondaryLocation')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\Depends('testHideLocation')]
     ...
     * Test for the unhideLocation() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testUnhideLocation')]
     ...
     * Test for the deleteLocation() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testDeleteLocation')]
     ...
     * Test for the copySubtree() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testCopySubtree')]
     ...
     * Test for the moveSubtree() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testMoveSubtree')]
     ...
     * Test for the moveSubtree() method.
     */
    #[\PHPUnit\Framework\Attributes\Depends('testMoveSubtreeUpdatesSubtreeProperties')]
