...
abstract class SearchBaseIntegrationTestCase extends BaseIntegrationTestCase
{
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('findProvider')]
    ...
    public static function fullTextFindProvider()
    {
    ...
    #[\PHPUnit\Framework\Attributes\Depends('testCreateTestContent')]
    #[\PHPUnit\Framework\Attributes\DataProvider('fullTextFindProvider')]
