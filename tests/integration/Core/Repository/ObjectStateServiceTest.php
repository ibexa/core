...
class ObjectStateServiceTest extends BaseTestCase
{
     ...
     * @return array
     */
    public static function getPrioritizedLanguagesList(): array
    {
        return [
            [[], null],
            [['eng-US'], null],
    ...
    public function testGetInitialObjectState(): void
    {
        ...
        self::assertEquals(['eng-GB' => 'Sindelfingen'], $initialObjectState->names);
        self::assertEquals('eng-GB', $initialObjectState->defaultLanguageCode);
    }
