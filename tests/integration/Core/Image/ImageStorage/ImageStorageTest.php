...
final class ImageStorageTest extends BaseCoreFieldTypeIntegrationTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pathGenerator = self::createStub(PathGenerator::class);
        $this->aliasCleaner = self::createStub(AliasCleanerInterface::class);
        $this->filePathNormalizer = $this->createMock(FilePathNormalizerInterface::class);
        $this->ioService = $this->createMock(IOServiceInterface::class);
        $this->fileExtensionBlackListValidator = self::createStub(FileExtensionBlackListValidator::class);
